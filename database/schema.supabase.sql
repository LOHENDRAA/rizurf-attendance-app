...
-- ############################################################################
-- SECTION 6 - DEV SEED (delete this whole section for a clean deployment)
-- ############################################################################
-- Uses a real intern id from the Intern Database (INT-0007, gabitautau@gmail.com)
-- so DEV_INTERN_REF / the API resolution have something to match. Replace if
-- that record changes.
-- ============================================================================
