...
function AdminCalendarDay({ date, isSelected, isToday, dayData, filterIntern, statusFilter, onSelect }) {
  ...
  return (
    <button className={className} onClick={() => onSelect(date)}>
